...
<title>NE Chen 的拍賣網站 -- 我的小天地</title>
...
<?php
    ...
    if (isset($_POST['upload'])) {
        ...
        $image_text = mysqli_real_escape_string($link, $_POST['image_text']);
      	...
      	$sql = "INSERT INTO merchandise (mname, category, uid, initial_price, img, start_date, end_date, description, present_price) VALUES ('$mname','$category', $uid, '$initial_price', '$image','$start_date','$end_date', '$image_text', '$initial_price')";
      	// execute query
    ...
    $result = mysqli_query($link, "SELECT * FROM merchandise WHERE uid = $uid");
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-9">
                    ...
                    <!-- Single Blog Area  -->
                    <?php
                        echo "<p>"."這裡是".$username_login."的小天地!"."</p>";
                                    ...
                                    echo '<div class="col-12 col-md-6">';
                                        ...
                                        echo '<div class="single-blog-content">';
                                            echo '<div class="line"></div>';
                                                ...
                                                echo "<form method='POST'  action='edit.php'>"."<input type='hidden' name='mid' value='$mid'>".
                                                      "<input type='hidden' name='tmp' value='0'>".
                                                      "<input class='btn subscribe-btn' data-toggle='modal'  type = 'submit' value='修改資料' >".
                                                      "</form>";
                                                // tmp目前為0，修改之後tmp變成1，顯示新的資料
